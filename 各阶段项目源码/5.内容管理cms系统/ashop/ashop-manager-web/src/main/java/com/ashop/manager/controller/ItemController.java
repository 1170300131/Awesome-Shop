...
public class ItemController {
     ...
     */
    @ResponseBody
    @RequestMapping(value = "item/save", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public AshopResult itemSave(TbItem item, String desc, String itemParams){
     ...
     */
    @ResponseBody
    @RequestMapping(value = "item/update", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public AshopResult itemUpdate(TbItem item, String desc, String itemParams){
